...
void QwtPlotOpenGLCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QwtPlotOpenGLCanvas *_t = static_cast<QwtPlotOpenGLCanvas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QwtPlotOpenGLCanvas::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_QwtPlotOpenGLCanvas.data,
      qt_meta_data_QwtPlotOpenGLCanvas,  qt_static_metacall, qt_meta_extradata_QwtPlotOpenGLCanvas, nullptr}
};
